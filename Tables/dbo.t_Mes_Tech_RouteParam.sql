...
[FDefaultValue] [nvarchar] (256) COLLATE Chinese_PRC_CI_AS NULL,
[FEntryID] [int] NULL,
...
GO
EXEC sp_addextendedproperty N'MS_Description', N'是否必填', 'SCHEMA', N'dbo', 'TABLE', N't_Mes_Tech_RouteParam', 'COLUMN', N'FIsRequired'
GO
